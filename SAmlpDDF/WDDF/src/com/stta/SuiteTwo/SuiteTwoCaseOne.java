...
public class SuiteTwoCaseOne extends SuiteTwoBase{
	...
	public void SuiteTwoCaseOneTest(String DataCol1, String DataCol2,String DataCol3,String DataCol4,String DataCol5, String ExpectedResult,String ActualResult) throws ParseException, InterruptedException{
		...
		//Date CustomerDOB = (Date) formatter.parse(DataCol2);
		 System.out.println("Testing Datas:" + DataCol1 +"-" + DataCol2 +"-" + DataCol3+"-" + DataCol4+"-" + DataCol5+"-" + ExpectedResult+"-" + ActualResult );
		...
		*/	 
		...
		driver.findElement(By.name("birthdate")).sendKeys("02/05/1979");
		// By Xpath value
		/*driver.findElement(By.xpath("id('main-content')/ui-view/ui-view/div[1]/div[1]/div/div/ui-view/form/div[2]/div/input")).clear();
		driver.findElement(By.xpath("id('main-content')/ui-view/ui-view/div[1]/div[1]/div/div/ui-view/form/div[2]/div/input")).sendKeys("01/01/1979");
		*/
		
		Boolean Birthcheck= driver.findElement(By.name("birthdate")).isEnabled();
		if (Birthcheck=true)
		{System.out.println("Birth input is Enabled");}
		
		System.out.println("Testing 9");
		
		System.out.println("Testing Passed DOB:"+ DataCol2);
		...
		*/
	    ...
	    System.out.println("Expected Result from Excel File|" + ExpectedResult );
	    	    
	    if (strPorC.equals(ExpectedResult))
	    	{
	    	System.out.println("IFF PASSES");
		...
		*/
		...
		if(Testfail){
			...
			s_assert.assertAll();		
			System.out.println("Testing 12"+ "----With in Test fail IFF");
		}
	//    closeWebBrowser();
	}
	...
	public void closeBrowser(){
		...
		System.out.println("Testing 13"+ "*****After Test");
	}
}